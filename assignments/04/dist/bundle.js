...
var Component = function (_React$Component) {
  ...
  function Component(props) {
    ...
    _this.userSearch = _this.userSearch.bind(_this);
    _this.loadPokemon = _this.loadPokemon.bind(_this);
    _this.state = {
      pokemon: ''
  ...
  _createClass(Component, [{
    ...
    value: function loadPokemon() {
      ...
      getAjaxPromise(url).then(JSON.parse).then(function (response) {
        ...
        var moves = response.moves[0].move.name;
        ...
        _this2.setState({ moves: moves });
        _this2.setState({ abilities: abilities });
      });
    }
  }, {
    key: 'userSearch',
    value: function userSearch(e) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          ' ',
          _react2.default.createElement('img', { src: 'who.png' })
        ),
        _react2.default.createElement(
          'div',
          { 'class': 'content' },
          _react2.default.createElement(
            'div',
            { 'class': 'inputs' },
            _react2.default.createElement('input', { 'class': 'inputBox', onChange: this.userSearch }),
            _react2.default.createElement(
              'button',
              { 'class': 'button', onClick: this.loadPokemon },
              'Search'
            )
          ),
          _react2.default.createElement(
            'div',
            { 'class': 'displayCon' },
            _react2.default.createElement('img', { 'class': 'image', src: this.state.image }),
            _react2.default.createElement(
              'p',
              { 'class': 'name' },
              ' Name: ',
